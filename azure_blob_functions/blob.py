...
blob_service_client = BlobServiceClient.from_connection_string(conn_str="DefaultEndpointsProtocol=https;AccountName=rileybackups;AccountKey=cs1FmLR0DFeU4Ya1NNBBTdOjcwYUqaRgDq9kk9+HqOQ7wSZHnYkknjQ/+59LGXb7zHwSS8zrzxQh+AStHNOLcQ==;EndpointSuffix=core.windows.net")
